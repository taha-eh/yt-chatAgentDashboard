...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-surface-200">
      <div className="flex flex-col h-full">
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-surface-200">
          ...
          <div>
            <h1 className="font-semibold text-surface-900">Agent Dashboard</h1>
            <p className="text-xs text-surface-500">Conversation Analytics</p>
          </div>
        </div>
